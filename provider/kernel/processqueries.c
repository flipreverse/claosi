...
static void setupQueries(void) {
	...
	INIT_SRC_STREAM(processUTimeStr,"process.process.utime",1,0,NULL,700);
	SET_SELECTOR_INT_STREAM(processUTimeStr,0,1)
}
